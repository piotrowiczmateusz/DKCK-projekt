...
//			while ((tempSapperReference.getTargetsArray().get(0).getPositionX() != itemReference.getPositionX())
//					|| (tempSapperReference.getTargetsArray().get(0).getPositionY() != itemReference.getPositionY())) {
				...
				} else if (tempSapperReference.getTargetsArray().get(0).getPositionX() < itemReference.getPositionX()) {
					itemReference.setPositionX(itemReference.getPositionX() - 1);
				}
				...
				} else if (tempSapperReference.getTargetsArray().get(0).getPositionY() < itemReference.getPositionY()) {
					itemReference.setPositionY(itemReference.getPositionY() - 1);
				}
